  ...
  return (
    <div style={{ minHeight: '100vh', background: '#C8A97A' }}>
      <nav style={{ background: '#2B6CB0', padding: '1rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Logo />
        <button onClick={() => navigate('/')} style={{ background: '#C53030', color: 'white', border: 'none', padding: '8px 16px', borderRadius: '8px', cursor: 'pointer', fontFamily: 'Georgia, serif' }}>Retour</button>
      </nav>

      <div style={{ maxWidth: '800px', margin: '2rem auto', padding: '0 1rem' }}>

        <div style={{ background: '#F5ECD8', borderRadius: '12px', padding: '2rem', border: '1px solid #A07840', marginBottom: '1.5rem' }}>
          <h1 style={{ color: '#1A365D', marginBottom: '1.5rem', fontSize: '24px' }}>Mentions Légales</h1>

          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>Éditeur du site</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>Hébergement</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>Propriété intellectuelle</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>Responsabilité</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8 }}>
        ...
        <div style={{ background: '#F5ECD8', borderRadius: '12px', padding: '2rem', border: '1px solid #A07840', marginBottom: '1.5rem' }}>
          <h1 style={{ color: '#1A365D', marginBottom: '1.5rem', fontSize: '24px' }}>Conditions Générales d'Utilisation</h1>

          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>1. Objet</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>2. Inscription</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>3. Réservations et paiements</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>4. Annulation</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>5. Avis et évaluations</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>6. Responsabilité des prestataires</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8, marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ color: '#2B6CB0', fontSize: '16px', marginBottom: '8px' }}>7. Droit applicable</h2>
          <p style={{ color: '#3D2B0F', fontSize: '14px', lineHeight: 1.8 }}>
            Les présentes CGU sont soumises au droit français. En cas de litige, les tribunaux de Nice seront compétents.
          </p>
        </div>

        <p style={{ color: '#3D2B0F', fontSize: '12px', textAlign: 'center', marginBottom: '2rem' }}>
