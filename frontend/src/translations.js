export const traductions = {
  fr: {
    ...
    panneau_admin: 'panneau administration',
    onglet_statistiques: 'Statistiques',
    onglet_revenus: '💰 Revenus',
    onglet_utilisateurs: 'Utilisateurs',
    onglet_signalements: '🚩 Signalements',
    onglet_parametres: '⚙️ Paramètres',
    total_utilisateurs: 'Total utilisateurs',
    clients_label: 'Clients',
    prestataires_label: 'Prestataires',
    commission_mois: 'Commission ce mois',
    commission_totale: 'Commission totale',
    volume_total: 'Volume total traité',
    taux_commission: 'Taux de commission',
    evolution_commission: 'Évolution de la commission (6 derniers mois)',
    pas_assez_graphique: 'Pas encore assez de données pour afficher un graphique.',
    supprimer_btn: 'Supprimer',
    aucun_signalement: 'Aucun signalement pour le moment.',
    signale_par: 'Signalé par :',
    prestataire_concerne: 'Prestataire concerné :',
    marquer_traite: 'Marquer traité',
    rejeter: 'Rejeter',
    parametres_plateforme: 'Paramètres de la plateforme',
    mode_maintenance_titre: '🚧 Mode maintenance',
    mode_maintenance_desc: "Quand activé, tous les visiteurs (sauf vous en tant qu'admin) voient une page \"On revient bientôt\" au lieu du site.",
    export_comptable_titre: '📊 Export comptable',
    export_comptable_desc: 'Générez un récapitulatif PDF des commissions perçues sur une période donnée, prêt pour votre comptabilité.',
    date_debut: 'Date de début',
    date_fin: 'Date de fin',
    generation_en_cours: 'Génération en cours...',
    telecharger_export: "📄 Télécharger l'export comptable",
    maintenance_active_badge: '🚧 Maintenance active'
  },
  en: {
    connexion: 'Login',
    inscription: 'Sign up',
    ...
    panneau_admin: 'admin panel',
    onglet_statistiques: 'Statistics',
    onglet_revenus: '💰 Revenue',
    onglet_utilisateurs: 'Users',
    onglet_signalements: '🚩 Reports',
    onglet_parametres: '⚙️ Settings',
    total_utilisateurs: 'Total users',
    clients_label: 'Clients',
    prestataires_label: 'Providers',
    commission_mois: 'Commission this month',
    commission_totale: 'Total commission',
    volume_total: 'Total volume processed',
    taux_commission: 'Commission rate',
    evolution_commission: 'Commission evolution (last 6 months)',
    pas_assez_graphique: 'Not enough data yet to display a chart.',
    supprimer_btn: 'Delete',
    aucun_signalement: 'No reports at the moment.',
    signale_par: 'Reported by:',
    prestataire_concerne: 'Provider concerned:',
    marquer_traite: 'Mark as resolved',
    rejeter: 'Reject',
    parametres_plateforme: 'Platform settings',
    mode_maintenance_titre: '🚧 Maintenance mode',
    mode_maintenance_desc: 'When enabled, all visitors (except you as admin) see a "Back soon" page instead of the site.',
    export_comptable_titre: '📊 Accounting export',
    export_comptable_desc: 'Generate a PDF summary of commissions earned over a given period, ready for your accounting.',
    date_debut: 'Start date',
    date_fin: 'End date',
    generation_en_cours: 'Generating...',
    telecharger_export: '📄 Download accounting export',
    maintenance_active_badge: '🚧 Maintenance active'
  },
  it: {
    connexion: 'Accesso',
    ...
    panneau_admin: 'panello amministrazione',
    onglet_statistiques: 'Statistiche',
    onglet_revenus: '💰 Entrate',
    onglet_utilisateurs: 'Utenti',
    onglet_signalements: '🚩 Segnalazioni',
    onglet_parametres: '⚙️ Impostazioni',
    total_utilisateurs: 'Totale utenti',
    clients_label: 'Clienti',
    prestataires_label: 'Fornitori',
    commission_mois: 'Commissione questo mese',
    commission_totale: 'Commissione totale',
    volume_total: 'Volume totale gestito',
    taux_commission: 'Tasso di commissione',
    evolution_commission: 'Andamento della commissione (ultimi 6 mesi)',
    pas_assez_graphique: 'Non ci sono ancora abbastanza dati per mostrare un grafico.',
    supprimer_btn: 'Elimina',
    aucun_signalement: 'Nessuna segnalazione al momento.',
    signale_par: 'Segnalato da:',
    prestataire_concerne: 'Fornitore coinvolto:',
    marquer_traite: 'Segna come risolto',
    rejeter: 'Rifiuta',
    parametres_plateforme: 'Impostazioni della piattaforma',
    mode_maintenance_titre: '🚧 Modalità manutenzione',
    mode_maintenance_desc: 'Quando attivata, tutti i visitatori (tranne tu come admin) vedono una pagina "Torniamo presto" invece del sito.',
    export_comptable_titre: '📊 Export contabile',
    export_comptable_desc: 'Genera un riepilogo PDF delle commissioni percepite in un determinato periodo, pronto per la tua contabilità.',
    date_debut: 'Data di inizio',
    date_fin: 'Data di fine',
    generation_en_cours: 'Generazione in corso...',
    telecharger_export: "📄 Scarica l'export contabile",
    maintenance_active_badge: '🚧 Manutenzione attiva'
  },
  ru: {
    connexion: 'Вход',
    ...
    panneau_admin: 'панель администратора',
    onglet_statistiques: 'Статистика',
    onglet_revenus: '💰 Доходы',
    onglet_utilisateurs: 'Пользователи',
    onglet_signalements: '🚩 Жалобы',
    onglet_parametres: '⚙️ Настройки',
    total_utilisateurs: 'Всего пользователей',
    clients_label: 'Клиенты',
    prestataires_label: 'Специалисты',
    commission_mois: 'Комиссия за этот месяц',
    commission_totale: 'Общая комиссия',
    volume_total: 'Общий обработанный объем',
    taux_commission: 'Ставка комиссии',
    evolution_commission: 'Динамика комиссии (последние 6 месяцев)',
    pas_assez_graphique: 'Пока недостаточно данных для отображения графика.',
    supprimer_btn: 'Удалить',
    aucun_signalement: 'Пока нет жалоб.',
    signale_par: 'Жалоба от:',
    prestataire_concerne: 'Специалист, на которого пожаловались:',
    marquer_traite: 'Отметить как решенное',
    rejeter: 'Отклонить',
    parametres_plateforme: 'Настройки платформы',
    mode_maintenance_titre: '🚧 Режим обслуживания',
    mode_maintenance_desc: 'Когда включено, все посетители (кроме вас как администратора) видят страницу "Скоро вернемся" вместо сайта.',
    export_comptable_titre: '📊 Бухгалтерский экспорт',
    export_comptable_desc: 'Создайте PDF-сводку полученных комиссий за определенный период, готовую для вашей бухгалтерии.',
    date_debut: 'Дата начала',
    date_fin: 'Дата окончания',
    generation_en_cours: 'Генерация...',
    telecharger_export: '📄 Скачать бухгалтерский экспорт',
    maintenance_active_badge: '🚧 Обслуживание активно'
  }
}